...
function Popup() {
  ...
  async function loadAuth() {
    ...
    setAuth(result);
    setMessage(result.authenticated ? `Profile data synced for ${result.email}` : result.configured ? "Sign in to sync your profile" : "Extension configuration is missing");
  }
