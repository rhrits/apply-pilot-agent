...
function Popup() {
  ...
  async function refreshProfile() {
    setMessage("Refreshing profile from Supabase…");
    const result = await chrome.runtime.sendMessage({ type: "REFRESH_PROFILE" } satisfies ExtensionMessage);
    setMessage(result?.profile ? "Profile synced from Supabase" : result?.error || "Profile refresh failed");
  }
  function openPanel() {
