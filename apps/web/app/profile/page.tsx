...
export default function ProfilePage() {
  ...
  function saveProfile() {
    ...
    supabase.auth.getUser().then(async ({ data }) => {
      ...
      const { error } = await supabase.from("profiles").upsert({ id: data.user.id, first_name: profile.firstName, last_name: profile.lastName, email: profile.email, phone: profile.phone, location: profile.location, linkedin_url: profile.linkedin, github_url: profile.github, portfolio_url: profile.portfolio, current_title: profile.currentTitle, summary: profile.summary });
